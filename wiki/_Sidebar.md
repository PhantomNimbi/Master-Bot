...
> **Master-Bot** — Unified Discord music, moderation & utility bot with embedded **Next.js 15 Web Dashboard**, dual PostgreSQL/SQLite fallbacks, and embedded **Lavalink v4 Audio**.
...
### 🚀 Getting Started
- [🏠 **Home**](Home) — Project overview & quick start
- [⚡️ **Getting Started**](Getting-Started) — Prerequisites, installation & startup
- [⚙️ **Configuration**](Configuration) — Complete `.env` reference & fallbacks
...
- [❓ **FAQ & Troubleshooting**](FAQ) — Common questions & solutions
- [🤝 **Contributing**](../CONTRIBUTING.md) — Contributor guide & commit standards
